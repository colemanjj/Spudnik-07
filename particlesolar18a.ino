/* A project to monitor water quality in remote locations
  ...
  pins and code are included for an analog vented depth sensor and a BME280 based depth sensor but the sensors
  are not implemented in Spudnik-09.
 ...
 * Input          : six boolean values
  ...
  * Return         : 0 Error, 1 Success
 *******************************************************************************/
 //pmic.setChargeVoltage(4512);  // for sealed lead-acit (SLA) battery. Probably isn't implemented in spark_wiring_power.cpp
